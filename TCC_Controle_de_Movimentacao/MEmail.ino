...
void setup(){
  ...
  Serial.println("Sem Moviment��o na Casa");
...
// Metodo Sala
void EnviarSala(){
  Serial.println("Aten��o!!! Movimenta��o na Sala");
  ...
  if (client.connect(server, 587)){
    ...
    recebe();
    delay(time);
    client.println("rcpt to: <c.henrique1309@gmail.com>"); // Email destinat�rio
    Serial.println("Destinat�rio: c.henrique1309@gmail.com");
    recebe();
    delay(time);
    client.println("data");
    recebe();
    delay(time);
    client.println("Subject: Alerta de Movimenta��o na sua Casa!"); // Assunto
    recebe();
    delay(time);
    client.println("Aten��o!!! Movimenta��o na Sala");// Corpo
    client.println();
 ...
 // Metodo Quarto
void EnviarQuarto(){
  Serial.println("Aten��o!!! Movimenta��o no Quarto");
  ...
  if (client.connect(server, 587)){
    ...
    recebe();
    delay(time);
    client.println("Aten��o!!! Movimenta��o no Quarto"); // Corpo
    client.println();
    client.println("~~~~ Carlos & Claudio (CC) ~~~~");
    recebe();
    delay(time);
